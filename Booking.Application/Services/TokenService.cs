...
namespace Booking.Application.Services
{
    public class TokenService : ITokenService
    {
        ...
        public string GenerateAccessToken(IEnumerable<Claim> claims)
        {
            ...
            var securityToken = new JwtSecurityToken(_issuer, _audience, claims, null, DateTime.UtcNow.AddMinutes(60), credentials);
        ...
        {
            var tokenValidatioParameters = new TokenValidationParameters()
            {
            ...
            var claimsPrincipal = tokenHandler.ValidateToken(accessToken, tokenValidatioParameters, out var securityToken);
        ...
        public async Task<BaseResult<TokenDto>> RefreshToken(TokenDto dto)
        {
            ...
            var user = await _userRepository.GetAll()
                .Include(x => x.UserToken)//загрузка связанных данных (с юзером)
